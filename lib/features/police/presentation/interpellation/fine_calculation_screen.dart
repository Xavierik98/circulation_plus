...
class FineCalculationScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Lecture depuis interpellationProvider (source de vérité unifiée)
    final interp = ref.watch(interpellationProvider);
    final selected = interp.selectedInfractions;
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                "Retournez à l'étape précédente et sélectionnez au moins une infraction.",
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text('Étape 5 sur 6', style: AppTextStyles.caption),
          ],
        ),
  ...
  /// Formate un montant XAF : 24000 → "24 000"
